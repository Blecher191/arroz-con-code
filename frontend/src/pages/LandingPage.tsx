  ...
  return (
    <section className="mx-auto flex max-w-3xl flex-col items-center gap-8 px-4 py-24 text-center">
      <h1 className="text-5xl font-extrabold leading-tight text-gray-900">
        ...
        <span className="text-indigo-600">in our language</span>
      </h1>
      <p className="text-lg text-gray-500">
        Get bilingual answers on education, healthcare, and technology —
        powered by AI and built by the community.
      </p>
